...
from models.utils import encode_panoptic
    ...
    for i, data in enumerate(data_loader):
        ...
        if isinstance(result[0], tuple):
            if len(result[0]) == 2:
                ...
                result = [(bbox_results, encode_mask_results(mask_results), parsing_res, parsing_score)
                          for bbox_results, mask_results, parsing_res, parsing_score in result]
