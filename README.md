...
We find the ground truth bugs of the PPP dataset in our local machine. The results are higher than the previous version. Thanks for the reminder by the original PPS dataset author [Daan de Geus](https://twitter.com/dcdegeus)
...
learn to optimize all three predictions as unified mask prediction
and classification problems. We design a decoupled decoder to
generate the part feature and thing/stuff feature respectively.
...
R-50 [link](https://1drv.ms/u/s!Ai4mxaXd6lVBgQAS47KqSrrMrXAV?e=VoS1Ge) PartPQ: 45.1

R-101 [link](https://1drv.ms/u/s!Ai4mxaXd6lVBgQMjRczqr5xgLxZ9?e=x3ZvE2) PartPQ: 45.6

Swin-base [link](https://1drv.ms/u/s!Ai4mxaXd6lVBgQHfYk6BNkDIU-Qh?e=4LNnVq) PartPQ: 52.3 


### Training and testing
For a single machine with multi GPUs. 
