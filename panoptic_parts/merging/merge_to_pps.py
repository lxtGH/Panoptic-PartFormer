...
if __name__ == '__main__':
    ...
    args.panoptic_pred_dir = '/data/cityscapes/gtFine/cityscapes_panoptic_val'
    args.panoptic_pred_json = '/data/cityscapes/annotations/cityscapes_panoptic_val.json'
    args.part_pred_path = '/data/cityscapes/bsanet_cpp_23_predictions'
    args.images_json = '/data/cityscapes/annotations/val_images.json'
    args.output_dir = '/home/xsl/'
